#!/usr/bin/env python3
"""Build the social preview card for the SAIR Andrews–Curtis Conjecture Challenge repository.
...
TITLE = "Andrews–Curtis"
SUBTITLE = "Short trivialisations of balanced presentations"
KEYWORDS = "invert · multiply · conjugate"
